...
opt.cnn   = torch.load('./shortcuts/VGGNet_0050.t7')
opt.cnn:evaluate()
...
logInfo = ''
cmd:log('./log/MOT16_128_5_noise_vgg_20170111.log',{logInfo})
...
while iteration < epochs do
    ...
    if iteration%10 == 0 then
        torch.save(string.format('./shortcuts/DDRLNet_MOT16_128_5_params_noise_vgg_60_%02d.t7',iteration),opt.ddlnet)
    end
    io.flush()
    collectgarbage()
end

torch.save(string.format('./shortcuts/DDRLNet_MOT16_128_5_noise_vgg_60_%04d.t7',iteration),opt.ddlnet)
